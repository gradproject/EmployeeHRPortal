...
<title>Employee HR Portal - Employee Login</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="loginForm" name="loginForm"
							action="/EmployeeHRPortal/LoginServlet" method="post"
...
<!-- 										</label>  -->
							...
							<div class="form-group">
								<label for="inputUserId3" class="col-sm-3 control-label">Employee
									ID</label>
								<div class="col-sm-6">
									<input type="text" class="form-control" id="inputUserId3"
										name="empId" value="<c:out value="${empId}"/>"
