...
<title>SampleWebApp - Employee Login</title>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<form id="loginForm" name="loginForm"
							action="/OnCampusJobsPortal/LoginServlet" method="post"
							class="form-horizontal" role="form">
							<div class="form-group">
								<label for="inputUserType1" class="col-sm-3 control-label">User
									Type</label>
								<div class="col-sm-9">
									<div data-toggle="buttons" class="btn-group">
										<label
											...
											class="col-sm-6 btn btn-primary <c:if test="${fn:contains(userType, 'Student')}">active</c:if>">
											<input type="radio" id="inputUserType2" name="userType"
											<c:if test="${fn:contains(userType, 'Student')}">checked="checked"</c:if>
							...
							<div class="form-group">
								<label for="inputUserId3" class="col-sm-3 control-label">User
									ID</label>
								<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="password" class="form-control" id="inputPassword4"
										name="password" value="" required="required" maxlength="20" />
								</div>
							</div>
							<div class="form-group">
					...
					<div class="panel-footer">
						Not Registered? <a href="/OnCampusJobsPortal/jsp/registration.jsp"
